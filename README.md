...
## Formulario 1663 (PLAME) — EsSalud/AFP

Algunas empresas usan el formulario 1663 (AFP Net / Planilla PLAME) 
que **no registra código de tributo** en el extracto SUNAT — aparece como `-`.

La app detecta automáticamente el formulario 1663 y lo acepta.
Los saldos pendientes de EsSalud y AFP se leen directamente del reporte 
de impuestos (que sí tiene el desglose por tributo).

Empresas con 1663: CREAMCASE y similares.
Empresas con 1662: TDD INVERSIONES y la mayoría.
